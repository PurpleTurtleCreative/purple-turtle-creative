...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			<?php
			$purple_turtle_creative_comment_count = get_comments_number();
			if ( '1' === $purple_turtle_creative_comment_count ) {
				printf(
					/* translators: 1: title. */
					esc_html__( 'One thought on &ldquo;%1$s&rdquo;', 'purple-turtle-creative' ),
		...
		if ( ! comments_open() ) :
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'purple-turtle-creative' ); ?></p>
			<?php
		endif;
